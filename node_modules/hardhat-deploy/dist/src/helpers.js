...
Note that in this case, the contract deployment will not behave the same if deployed without proxy.
    ...
    async function _deployViaDiamondProxy(name, options) {
        ...
        for (const facet of facetsSet) {
            ...
            abi = (0, utils_1.mergeABIs)([abi, (0, utils_1.filterABI)(artifact.abi, excludeSighashes)], {
                check: true,
            ...
            if (implementation.newlyDeployed) {
                ...
                const newFacet = {
                    facetAddress,
                    functionSelectors: sigsFromABI((0, utils_1.filterABI)(implementation.abi, excludeSighashes)),
                };
                ...
                const newFacet = {
                    facetAddress,
                    functionSelectors: sigsFromABI((0, utils_1.filterABI)(oldImpl.abi, excludeSighashes)),
                };
                facetSnapshot.push(newFacet);
                newSelectors.push(...newFacet.functionSelectors);
            }
